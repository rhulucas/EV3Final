...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cv_battery = findViewById(R.id.vv_battery);

        try {
            mref_ev3.mf_requestBatteryLevel(new EV3Service.OnBatteryLevelReceivedListener() {
                @Override
            ...
            e.printStackTrace();
            Toast.makeText(this, "Error requesting battery level: " + e.getMessage(), Toast.LENGTH_LONG).show();
        }
